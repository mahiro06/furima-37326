class RopsController < ApplicationController
  ...
  def order_params
    params.require(:rop_form).permit(:postal_code, :prefecture_id, :city, :building_address, :building, :tell).merge(user_id: current_user.id, item_id: params[:item_id], token: params[:token])
  end
